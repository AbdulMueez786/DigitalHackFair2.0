...
import com.example.digitalhackfair20.adapter.GroupChatAdapter;
...
public class GroupChat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(intent.getStringExtra("group_image"))
                .into(profile_image);
        this.userid = intent.getStringExtra("groupid");

        fuser = FirebaseAuth.getInstance().getCurrentUser();

        //      reference = FirebaseDatabase.getInstance().getReference("GroupChat").child(userid);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                user u = dataSnapshot.getValue(mess.class);
...
*/
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 200) {
            ...
            Toast.makeText(GroupChat.this, "Image selected", Toast.LENGTH_LONG).show();
    ...
    private void sendmessage(String sender, String reciever, final String message) {
        ...
        if (this.message_Type.matches("text") == true) {
            ...
            */
            ...
            String key = ref.child("GroupChat").child(userid).push().getKey();
            ref.child("GroupChat").child(userid).child(key).setValue(new message(key,
            ...
            */
            ...
            storageReference = storageReference.child("Groupchat/").child(key);
            storageReference.putFile(this.selectedImage_uri)
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            Toast.makeText(GroupChat.this, "complited", Toast.LENGTH_LONG).show();
                        }
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    task.addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            String key = ref.child("GroupChat").push().getKey();
                            ref.child("GroupChat").child(userid).child(key).setValue(new message(key,
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(GroupChat.this, "No internet,Try again", Toast.LENGTH_LONG).show();
                }
            });
    ...
    private void readmessage(final String myid, final String user_id, final String image_Url) {
        ...
        ls = new ArrayList<>();
        messageAdapter = new GroupChatAdapter(GroupChat.this, ls, user_id);
        rv.setAdapter(messageAdapter);
        reference = FirebaseDatabase.getInstance().getReference("GroupChat").child(user_id);
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ls.clear();
