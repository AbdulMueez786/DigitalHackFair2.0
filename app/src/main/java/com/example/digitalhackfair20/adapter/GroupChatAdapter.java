...
public class GroupChatAdapter extends RecyclerView.Adapter<GroupChatAdapter.ViewHolder> {
    ...
    private String group_id, name, group_image;
    private FirebaseUser fuser;


    public GroupChatAdapter(Context c, List<message> ls, String group_id) {
        this.c = c;
        this.ls = ls;
            ...
            public boolean onLongClick(View view) {
                ...
                dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        FirebaseDatabase.getInstance().getReference("GroupChat").child(group_id).child(chat.getId()).updateChildren(hm);
                    }
                });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView show_message, time, show_time;
        ;
